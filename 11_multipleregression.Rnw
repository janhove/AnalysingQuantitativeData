...
this means that $z$ must have been collected after the randomisation. 
...
Let's say that instead of merely observing and measuring all the
  ...
  \begin{enumerate}
    ...
    \item Which predictors would you include in the general linear model now?
...
@
  \begin{enumerate}
    ...
    would you expect for texts consisting of 64 tokens with a \textsc{ttr} of 0.7? \parend
  \end{enumerate}
